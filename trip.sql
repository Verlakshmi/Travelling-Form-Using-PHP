...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2499360734ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=trip&table=trip">`trip`.`trip`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="3e5353286925442c3d6c74777073562c">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="trip" targettable="trip">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `trip`.`trip` ( `sno` INT(3) NOT NULL AUTO_INCREMENT ,  `name` TEXT NOT NULL ,  `age` INT(3) NOT NULL ,  `gender` VARCHAR(8) NOT NULL ,  `email` VARCHAR(22) NOT NULL ,  `phone` INT(10) NOT NULL ,  `other` TEXT NOT NULL ,  `dt` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ,    PRIMARY KEY  (`sno`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="trip" targettable="trip">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `trip` (`sno`, `name`, `age`, `gender`, `email`, `phone`, `other`, `dt`) VALUES (&#039;1&#039;, &#039;testname&#039;, &#039;23&#039;, &#039;Male&#039;, &#039;this@this.com&#039;, &#039;9999999999&#039;, &#039;this is my first ever my phpmyadmin message&#039;, current_timestamp());</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `trip`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="trip" targettable="trip">
                            <div class="action_content">
